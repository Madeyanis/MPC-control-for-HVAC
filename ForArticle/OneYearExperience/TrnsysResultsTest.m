...
ville = 'Londre';
filePath = 'C:\Users\masdoua1\OneDrive\Research\Trnsys\building project\BuildingProject7\ResultsWithGainTheatOn.txt';
...
filePath2 = 'C:\Users\masdoua1\OneDrive\Research\Trnsys\building project\BuildingProject7\ResultsWithoutGainTheatOn.txt';
...
r = [zeros(1, 8), ones(1, 4), zeros(1, 1), ones(1, 5), zeros(1, 6)];
r = repmat(r, 1, 5);
