...
%% Plot Figures
% Figure 1: minimisation de l'erreure
figure(1)
plot(t, y(:, 2))
grid minor
hold on
...
ylim([0 1000])
legend('pb+pg', 'pv-pl')
title ('minimisation of load and production')

% Figure 3 Evolution de la charge de la batterie à travers le temps
figure(3)
plot(t, y(:, 1))
grid minor
title('Soc Evolution')
...
% Figure 2 Echange d'énergie avec la batterie et le grid
figure(2)  
plot(t, u(:, 1))
grid minor 
hold on
